        ...
        <div key={s.id} className="rounded-2xl border border-slate-200 bg-white p-5">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <p className="text-sm text-slate-400">{s.subdominio}.linkcommerce.cc · Plano {s.plano} · {s.moedaLoja === "AOA" ? `${s.precoMensal.toLocaleString("pt-AO")} Kz` : `€${s.precoMensal}`}/mês</p>
